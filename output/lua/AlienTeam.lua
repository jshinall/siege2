...
function AlienTeam:InitTechTree()
    ...
    self.techTree:AddActivation(kTechId.StructureContamination,  kTechId.BioMassNine,           kTechId.None)
    ...
    self.techTree:AddResearchNode(kTechId.SkulkRupture,          kTechId.BioMassTen, kTechId.None, kTechId.AllAliens)
    ...
    self.techTree:AddResearchNode(kTechId.SpiderGorge,              kTechId.BioMassTen, kTechId.None, kTechId.AllAliens)
    ...
    self.techTree:AddResearchNode(kTechId.PrimalScream,              kTechId.BioMassEleven, kTechId.None, kTechId.AllAliens)
    ...
    self.techTree:AddResearchNode(kTechId.AcidRocket,              kTechId.BioMassTwelve, kTechId.None, kTechId.AllAliens)
    ...
    self.techTree:AddResearchNode(kTechId.StompUpgrade,             kTechId.Stomp, kTechId.BioMassEight, kTechId.AllAliens) 
    self.techTree:AddResearchNode(kTechId.OniPoop,             kTechId.BoneShield, kTechId.BioMassFive, kTechId.AllAliens)        
