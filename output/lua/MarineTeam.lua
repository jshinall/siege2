...
function MarineTeam:InitTechTree()
   ...
   PlayingTeam.InitTechTree(self)
    ...
    self.techTree:AddResearchNode(kTechId.RifleClip,              kTechId.None, kTechId.None)
    ...
    self.techTree:AddTargetedActivation(kTechId.DropShotgun,     kTechId.ShotgunTech,         kTechId.None)
        ...
        self.techTree:AddResearchNode(kTechId.HeavyRifleTech,           kTechId.Armory,              kTechId.None)
    self.techTree:AddTargetedBuyNode(kTechId.HeavyRifle,            kTechId.AdvancedWeaponry,         kTechId.None)
    self.techTree:AddTargetedActivation(kTechId.DropHeavyRifle,     kTechId.AdvancedWeaponry,         kTechId.None)
