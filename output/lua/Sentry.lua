...
local kSentryGainXp =  0.6
local kSentryWeldGainXp =  0.1
local kSentryMaxLevel = 50
...
{    
    ...
    level = "float (0 to " .. kSentryMaxLevel .. " by .1)",
}
...
return self.level / kSentryMaxLevel * kSentryScaleSize
end
...
function Sentry:AddXP(amount)
    ...
    local xpReward = 0
        xpReward = math.min(amount, kSentryMaxLevel - self.level)
...
if Server then
    ...
    if trace.fraction < 1 then
        ...
        self:DoDamage(5 * (self.level/100) + 5, trace.entity, trace.endPoint, fireDirection, surface, false, true)
    ...
    function Sentry:OnUpdate(deltaTime)
        ...
        */
        ...
        self:AdjustMaxHealth(kSentryHealth * (self.level/kSentryMaxLevel) + kSentryHealth) 
