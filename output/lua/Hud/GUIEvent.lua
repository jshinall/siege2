...
local function GetUnlockIconParams(unlockId)
    ...
    if not kUnlockIconParams then
        ...
        kUnlockIconParams[kTechId.StompUpgrade] = { description = "Stomp Upgrade Researched" }
        kUnlockIconParams[kTechId.OniPoop] = { description = "Oni Poop Researched" }
        ...
        kUnlockIconParams[kTechId.SkulkRupture] = { description = "Acidic Vengeanced Researched" }
