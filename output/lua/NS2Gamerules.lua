...
function NS2Gamerules:OnUpdate(timePassed)
        ...
        //Siege Front & Siege Doors
         ...
         if ( Shared.GetTime() - self:GetGameStartTime() ) < kSiegeDoorTime then // and not Shared.GetCheatsEnabled() then
         ...
         if ( Shared.GetTime() - self:GetGameStartTime() ) > kFrontDoorTime and ( Shared.GetTime() - self:GetGameStartTime() ) < kFrontDoorTime + 1 then
          ...
          if ( Shared.GetTime() - self:GetGameStartTime() ) > kSiegeDoorTime and ( Shared.GetTime() - self:GetGameStartTime() ) < kSiegeDoorTime + 1 then
        ...
        if ( Shared.GetTime() - self:GetGameStartTime() ) > (kSiegeDoorTime + kTimeAfterSiegeOpeningToEnableSuddenDeath) then
