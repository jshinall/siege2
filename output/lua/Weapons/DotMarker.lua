...
local function ConstructTargetEntry(origin, hitEntity, damage, radius, ignoreLos, customImpactPoint, fallOffFunc)
  ...
  //  if not hitEntity or not hitEntity:GetIsAlive() or GetIsVortexed(hitEntity) or (tracey.entity ~= nil and tracey.entity:isa("FrontDoor")) or (tracex.entity ~= nil and tracex.entity:isa("FuncMoveable")) then
     if (tracex.entity ~= nil and tracex.entity:isa("FuncMoveable")) then
        return nil
    end    
