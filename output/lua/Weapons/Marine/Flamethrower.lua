...
local function ApplyConeDamage(self, player)
    ...
    for i = 1, 20 do
        ...
        if (tracey.entity ~= nil and tracey.entity:isa("FrontDoor")) or (tracet.entity ~= nil and tracet.entity:isa("LogicBreakable")) or (tracex.entity ~= nil and tracex.entity:isa("FuncMoveable")) then //or (tracez.entity ~= nil and tracez.entity:isa("FuncDoor") and tracez.entity:GetState() == Door.kState.Locked) then
        return 
         end    
