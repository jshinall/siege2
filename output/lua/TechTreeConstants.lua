...
kTechId = createTechIdEnum({
    ...
    // Weapon tech
    'AdvancedWeaponry', 'ShotgunTech', 'HeavyRifleTech', 'RifleClip', 'ArmoryArmor', 'MacWeldMacs', 'MacSpawnOff', 'MacSpawnOn', 'ArcSpawnOn', 'ArcSpawnOff', 'DetonationTimeTech', 'FlamethrowerRangeTech', 'GrenadeLauncherTech', 'FlamethrowerTech', 'FlamethrowerAltTech', 'WelderTech', 'MinesTech',
    ...
    // Weapons 
    'Rifle', 'Pistol', 'Shotgun', 'HeavyRifle', 'Claw', 'Minigun', 'Railgun', 'GrenadeLauncher', 'Flamethrower', 'Axe', 'LayMines', 'Welder', 'ExoFlamer', 'ExoWelder',
    ...
    'ContaminationTech', 'StructureContamination', 'RuptureTech', 'BoneWallTech',
    
    // Skulk abilities    
    'Bite', 'Sneak', 'Parasite', 'Leap', 'Xenocide', 'SkulkRupture',
    
    // gorge abilities
    'Spit', 'Spray', 'BellySlide', 'BabblerTech', 'BuildAbility', 'BabblerAbility', 'Babbler', 'BabblerEgg', 'GorgeTunnelTech', 'BileBomb',  'WebTech', 'SpiderGorge', 'Web', 'HydraTech',
    ...
    // onos abilities
    'Gore', 'Smash', 'Charge', 'BoneShield', 'Stomp', 'StompUpgrade', 'Shockwave', 'OniPoop',
    ...
    'Carapace', 'Regeneration', 'Redemption', 'Aura', 'Silence', 'Feint', 'Camouflage', 'Phantom', 'Celerity', 'Adrenaline', 'HyperMutation',  
