...
[kTechDataTooltipInfo] = "ARMORY_TOOLTIP"},
       ...
       [kTechDataHint] = "SENTRY_HINT", [kTechDataGhostModelClass] = "MarineGhostModel",
  ...
  [kTechDataTooltipInfo] = "ROBOTICS_FACTORY_TOOLTIP",
    [kTechDataObstacleRadius] = 2},        
     ...
     [kTechDataCostKey] = kHeavyRifleCost, },
        ...
        { [kTechDataId] = kTechId.DropHeavyRifle,   [kTechDataMapName] = HeavyRifle.kMapName, [kTechDataDisplayName] = "Onifle", [kTechIDShowEnables] = false,  [kTechDataTooltipInfo] =  "Because Testing", [kTechDataModel] = Rifle.kModelName, [kTechDataCostKey] = 20, [kStructureAttachId] = kTechId.AdvancedArmory, [kStructureAttachRange] = kArmoryWeaponAttachRange, [kStructureAttachRequiresPower] = true },
      ...
      [kTechDataTooltipInfo] = "Allows Macs to weld eachother."},
         ...
         { [kTechDataId] = kTechId.ArcSpawnOn,    
          [kTechDataCooldown] = 5,    
          [kTechDataDisplayName] = "Automatically spawn up to 8 arcs for you",       
         [kTechDataCostKey] = 0, 
         [kTechDataTooltipInfo] = "8 is currently the max amount to automatically spawn this way. Turning this on will automatically spawn up to this many for you"},
 ...
 [kTechDataTooltipInfo] = "+dmg +energy +rof to all teammates in range"},
        ...
        // tier 3
         ...
         { [kTechDataId] = kTechId.OniPoop,          [kTechDataCategory] = kTechId.Onos,  [kTechDataDisplayName] = "Oni Poop", [kTechDataCostKey] = kOnipoopResCost, [kTechDataResearchTimeKey] = kOniPoopResTime, [kTechDataTooltipInfo] = "Allows Oni to spawn clog + egg (poop) combination if holding down boneshield from 100% energy to 0% energy. (Might not work around shifts)" }, 
         
         
        { [kTechDataId] = kTechId.StompUpgrade,          [kTechDataCategory] = kTechId.Onos,  [kTechDataDisplayName] = "Stomp Upgrade", [kTechDataCostKey] = kStompResearchCost, [kTechDataResearchTimeKey] = kStompResearchTime, [kTechDataTooltipInfo] = "Spawns a small bonewall half duration of length to the original on an exo when stomped." }, 
        ...
        { [kTechDataId] = kTechId.SpiderGorge,        [kTechDataDisplayName] = "SpiderGorge", [kTechDataCostKey] = kSpiderGorgeResearchCost, [kTechDataResearchTimeKey] = kSpiderGorgeResearchTime, [kTechDataTooltipInfo] = "Spider gorge does whatever a spider gorge wants" },
        ...
        [kTechDataResearchTimeKey] = kXenocideResearchTime, 
           [kTechDataTooltipInfo] = "Siege modification: Base 200 dmg and +5% dmg against marines/jetpackmarines and +25% dmg against exo/structure"},
                 ...
                 { [kTechDataId] = kTechId.SkulkRupture,
         [kTechDataCategory] = kTechId.Skulk,
           [kTechDataDisplayName] = "Acidic Vengeance",
          [kTechDataCostKey] = kSkulkRuptureResearchCost,
        [kTechDataResearchTimeKey] = kSkulkRuptureResearchTime, 
         [kTechDataTooltipInfo] = "Spawns a rupture on death at skulk location"},
 ...
 [kTechDataTooltipInfo] = "Ranged Projectile dealing damage only to armor and structures"},
    ...
    [kTechDataTooltipInfo] = "CRAG_UMBRA_TOOLTIP"},
      ...
      //  { [kTechDataId] = kTechId.CragHeal,         [kTechDataDisplayName] = "HEAL",  [kTechDataTooltipInfo] = "CRAG_HEAL_TOOLTIP"},
        ...
        // Lifeform purchases
        { [kTechDataId] = kTechId.Redemption,     [kTechDataCategory] = kTechId.CragHive,     [kTechDataDisplayName] = "Redemption",  [kTechDataSponitorCode] = "B",    [kTechDataCostKey] = kRedemptionCost,  [kTechDataTooltipInfo] = "Will automatically return you to the hive after 3 seconds when below 40% HP (with a 30 sec cooldown). Also Spawns a hallucination cloud in your place.", },
    ...
    [kTechDataTooltipInfo] =  "CONTAMINATION_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.Rupture, [kTechDataCooldown] = kRuptureCooldown, [kTechDataMapName] = Rupture.kMapName, [kTechDataGhostModelClass] = "AlienGhostModel", [kTechDataDisplayName] = "RUPTURE", [kTechDataAllowStacking] = true, [kTechDataCollideWithWorldOnly] = true, [kTechDataRequiresInfestation] = true, [kTechDataIgnorePathingMesh] = true, [kTechDataCostKey] = kRuptureCost, [kTechDataTooltipInfo] =  "RUPTURE_TOOLTIP"},
               ...
               { [kTechDataId] = kTechId.StructureContamination,               
        [kTechDataDisplayName] = "Contamination", 
        [kTechDataCostKey] = kAdvancedWhipContaminationCost,   
         [kTechIDShowEnables] = false,       
          ...
          [kTechDataCooldown] = kContaminationCooldown,
           [kTechDataCostKey] = kContaminationCost,
         [kTechDataTooltipInfo] =  "Spawns contamination right at the whip. Does stack, meaning you can place the other contamination plus this one. Kinda makes up for the low hp value, eh?"},
