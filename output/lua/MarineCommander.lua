...
local gMarineMenuButtons =
{
    ...
    [kTechId.WeaponsMenu] = { kTechId.DropHeavyRifle, kTechId.DropShotgun, kTechId.DropGrenadeLauncher, kTechId.DropFlamethrower, kTechId.DropWelder,
                              kTechId.DropMines, kTechId.DropJetpack, kTechId.AssistMenu}
